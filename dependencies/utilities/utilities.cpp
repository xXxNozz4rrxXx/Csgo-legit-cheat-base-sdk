...
extern void utilities::reveal_competitive_ranks() {
    using server_rank_reveal_all = bool(__cdecl*)(int*);
    ...
    reinterpret_cast<server_rank_reveal_all>(fn_server_rank_reveal_all)(v);
}