...
bool interfaces::initialize() {
	...
	studio_render = get_interface<iv_studio_render, interface_type::index>("studiorender.dll", "VStudioRender026");
    ...
    surface_props = get_interface<IPhysicsSurfaceProps, interface_type::index>("vphysics.dll", "VPhysicsSurfaceProps001");
	...
	//weapon_system = *reinterpret_cast<i_weapon_system**>(findPattern("client", "\x8B\x35????\xFF\x10\x0F\xB7\xC0") + 2);
