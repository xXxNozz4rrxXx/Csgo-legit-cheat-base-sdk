...
public:
	...
	virtual void fire_game_event(i_game_event* m_pEvent) = 0;
	virtual int  get_event_debug_id(void) = 0;
public:
	int m_debug_id;
};

class c_custom_game_event_listener : public virtual i_game_event_listener2
{
public:
	virtual void fire_game_event(i_game_event* pEvent);
	virtual int  get_event_debug_id(void) { return EVENT_DEBUG_ID_INIT; };
public:
	int m_debug_id;
};
